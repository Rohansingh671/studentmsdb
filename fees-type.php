...
<script src="js/theme-script.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>
...
<div class="sidebar" id="sidebar">
    ...
    <li><a href="fees-type.php" class="active">Fees Type</a></li>
...
<div class="mb-2">
<a href="#" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_fees_Type"><i class="ti ti-square-rounded-plus-filled me-2"></i>Add
Fees Type</a>
</div>
</div>
</div>
...
<li>
<a class="dropdown-item rounded-1" href="#" data-bs-toggle="modal" data-bs-target="#edit_fees_Type"><i class="ti ti-edit-circle me-2"></i>Edit</a>
</li>
<li>
...
<label class="form-label">Fees Group</label>
<a href="#" class="text-primary" data-bs-toggle="modal" data-bs-target="#add_new_fees_group"><span><i class="ti ti-square-rounded-plus-filled"></i></span> Add
New</a>
</div>
<select class="select">
<option>Select</option>
...
<script src="js/jquery-3.7.1.min.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>

<script src="js/bootstrap.bundle.min.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>

<script src="js/moment.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>
<script src="js/daterangepicker.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>

<script src="js/feather.min.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>

<script src="js/jquery.slimscroll.min.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>

<script src="js/jquery.dataTables.min.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>
<script src="js/dataTables.bootstrap5.min.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>

<script src="js/select2.min.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>

<script src="js/script.js" type="86a32e0e4697e5cde91ccc0e-text/javascript"></script>
<script src="js/rocket-loader.min.js" data-cf-settings="86a32e0e4697e5cde91ccc0e-|49" defer=""></script>
</body></html>
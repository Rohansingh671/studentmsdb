                                            ...
                                            <div class="profile-upload">
                                                <div class="profile-uploader d-flex align-items-center">
                                                    <div class="drag-upload-btn mb-3">
                                                        Upload
                                                        <input type="file" class="form-control image-sign" multiple="" name="teacher_image">
                                                    </div>
                                ...
                                <div class="row row-cols-xxl-5 row-cols-md-6">
                                    <div class="col-xxl col-xl-3 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            $result = $mysqli->query("SELECT COUNT(ID) FROM addTeacher;");
                                            $row = $result->fetch_row();
                                            $total_teacher_id = $row[0] + 1;

                                            ?>
                                            <label class="form-label">Teacher ID</label>
                                            <input type="text" class="form-control" name="teacher_id" value="TID0<?php echo $total_teacher_id ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-xxl col-xl-3 col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-xxl col-xl-3 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="input-tags form-control" type="text" data-role="tagsinput" name="language_known" value="English, Spanish">
                                        </div>
                                    </div>
                                    <div class="col-xxl col-xl-3 col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-xxl col-xl-3 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="previous_school_contact_number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-12 col-xl-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" placeholder="Other Information" rows="4" name="other_info"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="select" name="work_location">
                                            <option>Select</option>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="medical_leaves">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Casual Leaves</label>
                                        <input type="text" class="form-control" name="casual_leaves">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Maternity Leaves</label>
                                        <input type="text" class="form-control" name="maternity_leaves">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap">
                                            <div class="btn btn-primary drag-upload-btn mb-2 me-2">
                                                ...
                                                <input type="file" class="form-control image_sign" multiple="" name="resume">
                                            </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap">
                                            <div class="btn btn-primary drag-upload-btn mb-2 me-2">
                                                ...
                                                <input type="file" class="form-control image_sign" multiple="" name="joining_letter">
                                            </div>
                                            <p class="mb-2">Resume.pdf</p>
                                        </div>
                                    </div>

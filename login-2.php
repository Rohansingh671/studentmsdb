...
<a href="javascript:void(0);" class="bg-primary br-10 p-2 btn btn-primary  d-flex align-items-center justify-content-center">
<img class="img-fluid m-1" src="images/facebook-logo.svg" alt="Facebook">
</a>
</div>
<div class="text-center me-2 flex-fill">
<a href="javascript:void(0);" class=" br-10 p-2 btn btn-outline-light  d-flex align-items-center justify-content-center">
<img class="img-fluid  m-1" src="images/google-logo.svg" alt="Facebook">
</a>
</div>
<div class="text-center flex-fill">
<a href="javascript:void(0);" class="bg-dark br-10 p-2 btn btn-dark d-flex align-items-center justify-content-center">
<img class="img-fluid  m-1" src="images/apple-logo.svg" alt="Apple">
</a>
</div>
</div>
</div>
...
<script src="js/jquery-3.7.1.min.js" type="a3b5d25ec26e31080edf6c15-text/javascript"></script>

<script src="js/bootstrap.bundle.min.js" type="a3b5d25ec26e31080edf6c15-text/javascript"></script>

<script src="js/feather.min.js" type="a3b5d25ec26e31080edf6c15-text/javascript"></script>

<script src="js/jquery.slimscroll.min.js" type="a3b5d25ec26e31080edf6c15-text/javascript"></script>

<script src="js/select2.min.js" type="a3b5d25ec26e31080edf6c15-text/javascript"></script>

<script src="js/script.js" type="a3b5d25ec26e31080edf6c15-text/javascript"></script>
<script src="js/rocket-loader.min.js" data-cf-settings="a3b5d25ec26e31080edf6c15-|49" defer=""></script>
</body></html>
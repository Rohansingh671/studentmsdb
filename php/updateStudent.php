...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $required_fields = [
        'academic_year', 'admission_number', 'admission_date', 'roll_number', 'status',
        'first_name', 'last_name', 'father_name', 'mother_name', 'guardian_name',
        'class', 'section', 'gender', 'dob', 'current_addressOfStudent',
        'permanent_addressOfStudent', 'districtOfStudent', 'provinceOfStudent',
        'transportationRoute', 'vehicleNumber', 'pickUpPoint', 'hostel', 'hostelRoomNumber',
        'allergiesOfStudent', 'medicationOfStudent',
        'previousSchoolName', 'previousSchoolAddress', 'bankName', 'branchOfBank', 'ifscNumber'
    ];
    ...
    $stmt = $mysqli->prepare("UPDATE `addstudent` SET 
        ...
        `imageOfMother` = IFNULL(?, `imageOfMother`), `imageOfGuardian` = IFNULL(?, `imageOfGuardian`)
...
$stmt->bind_param(
    ...
    $academic_year, $admission_date, $roll_number, $status,
    $first_name, $last_name, $class, $section, $gender,
    $dob, $current_address, $permanent_address,
    $district, $province, $transport_route, $vehicle_number,
    $pick_up_point, $hostel, $hostel_room_number,
    $allergies, $medication, $previous_school_name, $previous_school_address,
    $bank_name, $branch_of_bank, $ifsc_number, $primary_contact, $email,
    $mother_tongue, $languages_known, $father_name, $father_contact,
    $mother_name, $mother_contact, $guardian_name, $guardian_contact,
    $imageOfStudent, $imageOfFather, $imageOfMother, $imageOfGuardian, $admission_number
);

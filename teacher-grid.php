...
<div class="sidebar" id="sidebar">
    ...
    <ul>
    <li><a href="teacher-grid.php" class="active">All Teachers</a></li>
...
<a href="teachers.php" class=" btn btn-icon btn-sm me-1 bg-light primary-hover"><i class="ti ti-list-tree"></i></a>
<a href="teacher-grid.php" class=" active btn btn-icon btn-sm  primary-hover"><i class="ti ti-grid-dots"></i></a>
</div>
...
<a href="teacher-details.php" class="link-primary"><?php echo $teacher['teacher_id']; ?></a>
<div class="d-flex align-items-center">
...
<div class="d-flex align-items-center">
<a href="teacher-details.php" class="avatar avatar-lg flex-shrink-0"><img src="./php/uploads/teacher_images/<?php echo $teacher['teacher_image']; ?>" class="img-fluid rounded-circle" alt="img"></a>
<div class="ms-2">
<h6 class="text-dark text-truncate mb-0"><a href="teacher-details.php"><?php echo $teacher['first_name'] . " " . $teacher['last_name'];  ?></a></h6>
...
<a href="teacher-details.php" class="btn btn-light btn-sm">View Details</a>
</div>
</div>
</div>
<?php } ?>

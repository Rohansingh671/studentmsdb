...
<script src="js/theme-script.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>
...
<div class="mb-3">
<label class="form-label">Name</label>
<input type="text" class="form-control" placeholder="Enter Name" value="English">
</div>
<div class="mb-3">
<label class="form-label">Code</label>
<select class="select">
...
<script src="js/jquery-3.7.1.min.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>

<script src="js/bootstrap.bundle.min.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>

<script src="js/moment.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>
<script src="js/daterangepicker.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>

<script src="js/feather.min.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>

<script src="js/jquery.slimscroll.min.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>

<script src="js/jquery.dataTables.min.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>
<script src="js/dataTables.bootstrap5.min.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>

<script src="js/select2.min.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>

<script src="js/script.js" type="a40dff15a15f11ddb1b96a99-text/javascript"></script>
<script src="js/rocket-loader.min.js" data-cf-settings="a40dff15a15f11ddb1b96a99-|49" defer=""></script>
</body></html>
<!DOCTYPE html><html lang="en"><head>
	...
	<!-- Theme Script -->
	<script src="js/theme-script.js" type="1e4750fbb850894947d71c91-text/javascript"></script>
...
<body>
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="class-routine.php"><i class="ti ti-bell-school"></i><span>Class
                                            Routine</span></a></li>
                                <li  class="active"><a href="class-section.php"><i
			...
			<div class="content">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between mb-3">
					<div class="my-auto mb-2">
						<h3 class="page-title mb-1">Sections</h3>
						<nav>
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
						...
						<div class="mb-2">
							<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_class_section"><i class="ti ti-square-rounded-plus-filled me-2"></i>Add
								Section</a>
						</div>
					</div>
				</div>
											...
											<div class="d-flex align-items-center">
												<div class="dropdown">
													...
													<ul class="dropdown-menu dropdown-menu-right p-3">
														...
														<li>
															<a class="dropdown-item rounded-1" href="#" data-bs-toggle="modal" data-bs-target="#edit_class_section"><i class="ti ti-edit-circle me-2"></i>Edit</a>
														</li>
														<li>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									<div class="mb-3">
										<label class="form-label">Section</label>
										<input type="text" class="form-control" placeholder="Enter Section" value="A">
									</div>
									<div class="d-flex align-items-center justify-content-between">
										<div class="status-title">
											<h5>Status</h5>
	...
	<!-- jQuery -->
	<script src="js/jquery-3.7.1.min.js" type="1e4750fbb850894947d71c91-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="js/bootstrap.bundle.min.js" type="1e4750fbb850894947d71c91-text/javascript"></script>

	<!-- Daterangepikcer JS -->
	<script src="js/moment.js" type="1e4750fbb850894947d71c91-text/javascript"></script>
	<script src="js/daterangepicker.js" type="1e4750fbb850894947d71c91-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="js/feather.min.js" type="1e4750fbb850894947d71c91-text/javascript"></script>

	<!-- Slimscroll JS -->
	<script src="js/jquery.slimscroll.min.js" type="1e4750fbb850894947d71c91-text/javascript"></script>

	<!-- Select2 JS -->
	<script src="js/select2.min.js" type="1e4750fbb850894947d71c91-text/javascript"></script>

	<!-- Datatable JS -->
	<script src="js/jquery.dataTables.min.js" type="1e4750fbb850894947d71c91-text/javascript"></script>
	<script src="js/dataTables.bootstrap5.min.js" type="1e4750fbb850894947d71c91-text/javascript"></script>

	<!-- Custom JS -->
	<script src="js/script.js" type="1e4750fbb850894947d71c91-text/javascript"></script>

<script src="js/rocket-loader.min.js" data-cf-settings="1e4750fbb850894947d71c91-|49" defer=""></script>

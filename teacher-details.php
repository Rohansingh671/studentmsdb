...
<div class="sidebar" id="sidebar">
    ...
    <li><a href="teacher-details.php" class="active">Teacher Details</a></li>
...
<a href="edit-teacher.php" class="btn btn-primary d-flex align-items-center mb-2"><i class="ti ti-edit-circle me-2"></i>Edit Teacher</a>
</div>
</div>
</div>
...
<li>
<a href="teacher-details.php" class="nav-link active"><i class="ti ti-school me-2"></i>Teacher Details</a>
</li>
<li>
<a href="routine-teachers.php" class="nav-link"><i class="ti ti-table-options me-2"></i>Routine</a>
</li>
<li>
<a href="teacher-leaves.php" class="nav-link"><i class="ti ti-calendar-due me-2"></i>Leave &amp; Attendance</a>
</li>
<li>
<a href="teacher-salary.php" class="nav-link"><i class="ti ti-report-money me-2"></i>Salary</a>
</li>
<li>
<a href="teacher-library.php" class="nav-link"><i class="ti ti-bookmark-edit me-2"></i>Library</a>
</li>
</ul>

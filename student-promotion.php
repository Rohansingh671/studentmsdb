...
<script src="js/theme-script.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>
...
<div class="sidebar" id="sidebar">
    ...
    <li><a href="student-promotion.php" class="active">Student Promotion</a></li>
    </ul>
    </li>
    <li class="submenu" hidden>
...
<div class="card-body">
<form action="student-promotion.php">
...
<div>
<label class="form-label mb-2">Promotion from Class<span class="text-danger"> *</span></label>
...
<a href="#" class="badge bg-primary badge-xl exchange-link text-white d-flex align-items-center justify-content-center mx-md-4 mx-auto my-md-0 my-4 flex-shrink-0">
<span><i class="ti ti-arrows-exchange fs-16"></i></span>
</a>
<div class="card flex-fill w-100">
<div class="card-body pb-1">
<div class="mb-3">
<label class="form-label">Promote to Session <span class="text-danger"> *</span></label>
<select class="select">
<option>Select</option>
...
<div>
<label class="form-label mb-2">Assign to Section<span class="text-danger"> *</span></label>
<div class="d-block d-md-flex">
<div class="mb-0 flex-fill me-0">
<label class="form-label">Class</label>
<select class="select">
<option>Select</option>
...
<td><a href="student-details.php" class="link-primary">AD9892434</a></td>
<td>35013</td>
<td>
<div class="d-flex align-items-center">
...
<td>A</td>
<td>
<span class="badge badge-soft-success d-inline-flex align-items-center"><i class="ti ti-circle-filled fs-5 me-1"></i>Pass</span>
</td>
<td>
...
<td><a href="student-details.php" class="link-primary">AD9892433</a></td>
<td>35013</td>
<td>
<div class="d-flex align-items-center">
...
<td><a href="student-details.php" class="link-primary">AD9892432</a></td>
<td>35011</td>
<td>
<div class="d-flex align-items-center">
...
<td><a href="student-details.php" class="link-primary">AD9892431</a></td>
<td>35010</td>
<td>
<div class="d-flex align-items-center">
...
<td><a href="student-details.php" class="link-primary">AD9892430</a></td>
<td>35009</td>
<td>
<div class="d-flex align-items-center">
...
<td>B</td>
<td>
<span class="badge badge-soft-danger d-inline-flex align-items-center"><i class="ti ti-circle-filled fs-5 me-1"></i>Fail</span>
</td>
<td>
<div class="table-select mb-0">
<select class="select">
...
<td><a href="student-details.php" class="link-primary">AD9892429</a></td>
<td>35008</td>
<td>
<div class="d-flex align-items-center">
...
<td><a href="student-details.php" class="link-primary">AD9892428</a></td>
<td>35007</td>
<td>
<div class="d-flex align-items-center">
...
<td><a href="student-details.php" class="link-primary">AD9892427</a></td>
<td>35006</td>
<td>
<div class="d-flex align-items-center">
...
<td><a href="student-details.php" class="link-primary">AD9892426</a></td>
<td>35005</td>
<td>
<div class="d-flex align-items-center">
...
<td><a href="student-details.php" class="link-primary">AD9892425</a></td>
<td>35004</td>
<td>
<div class="d-flex align-items-center">
<a href="student-details.php" class="avatar avatar-md"><img src="images/student-10.jpg" class="img-fluid rounded-circle" alt="img"></a>
<div class="ms-2">
...
<td><a href="student-details.php" class="link-primary">AD9892424</a></td>
<td>35003</td>
<td>
<div class="d-flex align-items-center">
<a href="student-details.php" class="avatar avatar-md"><img src="images/student-11.jpg" class="img-fluid rounded-circle" alt="img"></a>
<div class="ms-2">
<p class="text-dark mb-0"><a href="student-details.php">Veronica</a></p>
</div>
</div>
</td>
<td>IX</td>
...
<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#student_promote">Promote Students</a>
</div>
<div class="toast-container success-msg-toast position-fixed">
<div id="topright-Toast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
<div class="toast-header">
<p class="me-auto"><span><i class="ti ti-square-check-filled text-success"></i></span>Successfully
Promoted</p>
<a href="#" class="toast-close" data-bs-dismiss="toast" aria-label="Close"><span><i class="ti ti-x"></i></span>
</a>
</div>
</div>
</div>
...
<script src="js/jquery-3.7.1.min.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>

<script src="js/bootstrap.bundle.min.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>

<script src="js/moment.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>
<script src="js/daterangepicker.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>

<script src="js/select2.min.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>

<script src="js/feather.min.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>

<script src="js/toastr.min.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>
<script src="js/toastr.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>

<script src="js/jquery.slimscroll.min.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>

<script src="js/jquery.dataTables.min.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>
<script src="js/dataTables.bootstrap5.min.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>

<script src="js/script.js" type="ce8a1764f9c61b71d3b1d00b-text/javascript"></script>
<script src="js/rocket-loader.min.js" data-cf-settings="ce8a1764f9c61b71d3b1d00b-|49" defer=""></script>
</body></html>
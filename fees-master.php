...
<head>
    ...
    <script src="js/theme-script.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>
...
<body>
                            ...
                            <ul>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="subdrop active"><i
                                            class="ti ti-report-money"></i><span>Fees
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="fees-master.php" class="active">Fees Master</a></li>
    ...
    <script src="js/jquery-3.7.1.min.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>

    <script src="js/bootstrap.bundle.min.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>

    <script src="js/moment.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>
    <script src="js/daterangepicker.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>

    <script src="js/feather.min.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>

    <script src="js/jquery.slimscroll.min.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>

    <script src="js/jquery.dataTables.min.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>
    <script src="js/dataTables.bootstrap5.min.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>

    <script src="js/select2.min.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>

    <script src="js/bootstrap-datetimepicker.min.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>

    <script src="js/script.js" type="d66ce4a64dcfedf2d8bdfeaa-text/javascript"></script>
    <script src="js/rocket-loader.min.js" data-cf-settings="d66ce4a64dcfedf2d8bdfeaa-|49" defer=""></script>
</body>

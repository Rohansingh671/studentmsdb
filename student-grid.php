                        ...
                        <li>
                            <ul>
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a href="student-grid.php" class="active">All Students</a></li>
                ...
                <div class="bg-white p-3 border rounded-1 d-flex align-items-center justify-content-between flex-wrap mb-4 pb-0">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-center bg-white border rounded-2 p-1 mb-3 me-2">
                            <a href="students.php" class="btn btn-icon btn-sm me-1 bg-light primary-hover"><i class="ti ti-list-tree"></i></a>
                            <a href="student-grid.php" class="active btn btn-icon btn-sm primary-hover"><i class="ti ti-grid-dots"></i></a>
                        </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <a href="student-details.php" class="link-primary"><?php echo $student['admission_number']; ?></a>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right p-3">
                                            ...
                                            <li>
                                                <a class="dropdown-item rounded-1" href="student-promotion.php"><i class="ti ti-arrow-ramp-right-2 me-2"></i>Promote Student</a>
                                            </li>
                                            <li>
                            ...
                            <div class="card-body">
                                <div class="bg-light-300 rounded-2 p-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="student-details.php" class="avatar avatar-lg flex-shrink-0"><img src="<?php echo $student['image_path']; ?>" class="img-fluid rounded-circle" alt="img"></a>
                                        <div class="ms-2">
                                            <h5 class="mb-0"><a href="student-details.php"><?php echo $student['first_name'] . " " . $student['last_name']; ?></a></h5>

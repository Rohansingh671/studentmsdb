                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="#" class="link-primary"><?php echo $group['feesGroupID']; ?></a></td>
                                            <td><?php echo $group['feesGroup']; ?></td>
                                            <td><?php echo $group['feesGroupAmount']; ?></td>
                                            <td><?php echo $group['remark']; ?></td>
                                            <td>
                                                <span class="badge badge-soft-success d-inline-flex align-items-center
"><i class="ti ti-circle-filled fs-5 me-1"></i><?php echo $group['feesGroupStatus']; ?></span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="dropdown">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    $result = $mysqli->query("SELECT COUNT(ID) FROM addfeesgroup;");
                                    $row = $result->fetch_row();
                                    $total_group_id = $row[0] + 1;
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="switch-sm" name="feesGroupStatus">
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<head>
    ...
    <script src="js/theme-script.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>
...
<body>
                    ...
                    <ul>
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="routine-teachers.php" class="active">Routine</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <ul>
                                ...
                                <li><a href="class-room.php"><i class="ti ti-building"></i><span>Class
                                            Room</span></a>
                                </li>
                                <li><a href="class-routine.php"><i class="ti ti-bell-school"></i><span>Class
                                            Routine</span></a></li>
                                <li><a href="class-section.php"><i
                    ...
                    <div class="col-md-12">
                        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                            ...
                            <div class="d-flex my-xl-auto right-content align-items-center  flex-wrap">
                                ...
                                <a href="edit-teacher.php" class="btn btn-primary d-flex align-items-center mb-2"><i
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center flex-wrap row-gap-3">
                                    <div
                                        ...
                                        <img src="images/teacher-01.jpg" class="img-fluid" alt="img">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                data-cfemail="375d565977524f565a475b521954585a">[email�&nbsp;protected]</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bottom mb-4">
                                    ...
                                    <li>
                                        <a href="routine-teachers.php" class="nav-link active"><i
                                                class="ti ti-table-options me-2"></i>Routine</a>
                                    </li>
                                    <li>
                                        <a href="teacher-leaves.php" class="nav-link "><i
                                                class="ti ti-calendar-due me-2"></i>Leave &amp; Attendance</a>
                                    </li>
                                    <li>
                                        <a href="teacher-salary.php" class="nav-link "><i
                                                class="ti ti-report-money me-2"></i>Salary</a>
                                    </li>
                                    <li>
                                        <a href="teacher-library.php" class="nav-link"><i
                                            ...
                                            <div class="d-flex flex-column me-4 flex-fill">
                                                ...
                                                <div class="rounded p-3 mb-4 border">
                                                    <div class="pb-3 border-bottom">
                                                        <span
                                                            class="text-danger badge bg-transparent-danger text-nowrap ">Room
                                                            No:104</span>
                                                    </div>
                                                    <span class="text-dark d-block py-2">Class : III, A</span>
                                                    <span class="text-dark d-block pb-2">Subject : Spanish</span>
                                                    <p class="text-dark"><i class="ti ti-clock me-1"></i>09:45 -10:30 AM
                                                    </p>
                                                </div>
                                                <div class="rounded p-3 mb-4 border">
                                                    <div class="pb-3 border-bottom">
                                                    ...
                                                    <p class="text-dark text-nowrap m-0"><i
                                                ...
                                                <div class="rounded p-3 mb-4 border">
                                                    ...
                                                    <p class="text-dark d-block pb-2 m-0">Subject : Spanish</p>
                                                    <p class="text-dark text-nowrap m-0"><i
                                                            class="ti ti-clock me-1"></i>03:15 - 04:00 AM</p>
                                                </div>
                                                <div class="rounded p-3 mb-4 border">
                                                    <div class="pb-3 border-bottom">
                                                        <span
                                                    ...
                                                    <p class="text-dark text-nowrap m-0"><i
                                                            class="ti ti-clock me-1"></i>11:30 - 12:15 AM</p>
                                                </div>
                                                <div class="rounded p-3 mb-4 border">
                                                    <div class="pb-3 border-bottom">
                                                        <span
                                                    ...
                                                    <p class="text-dark d-block pb-2 m-0">Subject : Spanish</p>
                                                    <p class="text-dark text-nowrap m-0"><i
                                                            class="ti ti-clock me-1"></i>02:15 - 03:00 AM</p>
                                                </div>
                                                <div class="rounded p-3 mb-4 border">
                                                    <div class="pb-3 border-bottom">
                                                        <span
    ...
    <div class="modal fade" id="apply_leave">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="student-leaves.php">
    ...
    <script src="js/jquery-3.7.1.min.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>

    <script src="js/bootstrap.bundle.min.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>

    <script src="js/moment.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>
    <script src="js/daterangepicker.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>
    <script src="js/bootstrap-datetimepicker.min.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>

    <script src="js/feather.min.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>

    <script src="js/jquery.slimscroll.min.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>

    <script src="js/select2.min.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>

    <script src="js/jquery.dataTables.min.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>
    <script src="js/dataTables.bootstrap5.min.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>

    <script src="js/ResizeSensor.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>
    <script src="js/theia-sticky-sidebar.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>

    <script src="js/script.js" type="d5cdf2c92661195df03450e3-text/javascript"></script>
    <script src="js/rocket-loader.min.js" data-cf-settings="d5cdf2c92661195df03450e3-|49" defer=""></script>
</body>
